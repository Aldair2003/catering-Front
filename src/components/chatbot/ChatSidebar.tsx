...
const ChatSidebar: React.FC = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 h-full z-50 transition-all duration-300 ${minimized ? 'w-16' : 'w-80'} bg-white shadow-xl border-r border-gray-200 flex flex-col`}>
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-orange-500 to-orange-700">
      ...
      {!minimized && (
        <>
          <div className="flex-1 overflow-y-auto px-4 py-2 space-y-2 bg-gray-50" style={{ maxHeight: 'calc(100vh - 120px)' }}>
            {messages.length === 0 && (
